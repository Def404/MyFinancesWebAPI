...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<DesiredProduct>(entity =>
        {
            ...
            entity.ToTable("desired_products", tb => tb.HasComment("Сущность для товара, который пользователь намерен приобрести в будущем"));
        ...
        modelBuilder.Entity<InterestRate>(entity =>
        {
            ...
            entity.ToTable("interest_rates", tb => tb.HasComment("Данная сущность требуется для записи процентных ставок для кредита"));
        ...
        modelBuilder.Entity<LocalStorage>(entity =>
        {
            ...
            entity.ToTable("local_storage", tb => tb.HasComment("Сущность хранилища, предназначенное для наличных денег, например, кошелек, копилка и т.п."));
        ...
        modelBuilder.Entity<Subscription>(entity =>
        {
            ...
            entity.ToTable("subscriptions", tb => tb.HasComment("Сущность для подписок на различные сервисы (например, музыка)"));
